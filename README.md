...
2. Download the stunnel android binary from [stunnel.org](https://www.stunnel.org/index.html), and copy it to /app/src/main/jniLibs/arm64-v8a/lib_stunnel.so (or other architecure)
